...
public:
    ...
    float get_torque_x_Nm() const { return state.torque_Nm.x; }
    float get_torque_y_Nm() const { return state.torque_Nm.y; }
    float get_torque_z_Nm() const { return state.torque_Nm.z; }
